export default function Footer() {
  return (
    <footer className="bg-black-deep border-t border-offwhite/10">
      ...
      >
        <a href="#" aria-label="JustMaley" className="flex items-center gap-3">
          <img src="/logo-wt.svg" alt="" width="32" height="32" className="h-7 w-auto opacity-70" />
          <span className="text-offwhite/70 font-semibold tracking-tight text-sm">JustMaley</span>
        </a>
        ...
        <p className="text-offwhite/30 text-xs tabular-nums">© 2026 JustMaley</p>
      </div>
    </footer>
  )
}
